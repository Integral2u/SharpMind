...
public static partial class GPUQuantizationKernels
{
    ...
    [PuzzlePeice(nameof(QuantizationOps.QuantizedMatMulQ8_0), QuantizationConfig.KeyQuantizedMatMulQ8_0, GPUSharpMindConfig.ValQuantizedMatMulQ8_0_Serial)]
    ...
    [PuzzlePeice(nameof(QuantizationOps.QuantizedMatMulQ8_0), QuantizationConfig.KeyQuantizedMatMulQ8_0, GPUSharpMindConfig.ValQuantizedMatMulQ8_0_Parallel)]
    ...
    [PuzzlePeice(nameof(QuantizationOps.QuantizedMatMulQ8_1), QuantizationConfig.KeyQuantizedMatMulQ8_1, GPUSharpMindConfig.ValQuantizedMatMulQ8_1_Serial)]
    ...
    [PuzzlePeice(nameof(QuantizationOps.QuantizedMatMulQ8_1), QuantizationConfig.KeyQuantizedMatMulQ8_1, GPUSharpMindConfig.ValQuantizedMatMulQ8_1_Parallel)]
    ...
    [PuzzlePeice(nameof(QuantizationOps.QuantizedMatMulQ8K), QuantizationConfig.KeyQuantizedMatMulQ8K, GPUSharpMindConfig.ValQuantizedMatMulQ8K_Serial)]
    ...
    [PuzzlePeice(nameof(QuantizationOps.QuantizedMatMulQ8K), QuantizationConfig.KeyQuantizedMatMulQ8K, GPUSharpMindConfig.ValQuantizedMatMulQ8K_Parallel)]

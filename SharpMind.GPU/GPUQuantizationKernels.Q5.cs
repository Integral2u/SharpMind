...
{
    [PuzzlePeice(QuantizationKeys.KeyVecDotQ5_0, QuantizationKeys.KeyVecDotQ5_0, GPUSharpMindConfig.ValVecDotQ5_0)]
    ...
    [PuzzlePeice(QuantizationKeys.KeyVecDotQ5_1, QuantizationKeys.KeyVecDotQ5_1, GPUSharpMindConfig.ValVecDotQ5_1)]
    ...
    [PuzzlePeice(QuantizationKeys.KeyVecDotQ5K, QuantizationKeys.KeyVecDotQ5K, GPUSharpMindConfig.ValVecDotQ5K)]
    ...
    [PuzzlePeice(QuantizationKeys.KeyQuantizedMatMulQ5_0, QuantizationKeys.KeyQuantizedMatMulQ5_0, GPUSharpMindConfig.ValQuantizedMatMulQ5_0_Serial)]
    ...
    [PuzzlePeice(QuantizationKeys.KeyQuantizedMatMulQ5_0, QuantizationKeys.KeyQuantizedMatMulQ5_0, GPUSharpMindConfig.ValQuantizedMatMulQ5_0_Parallel)]
        ...
        int M, int K, int N)
    {
        if (M <= 1)
        {
            DecodeParallelGPU(VecDotQ5_0_GPU, input, rawWeights, output, K, N);
        }
        else
        {
    ...
    [PuzzlePeice(QuantizationKeys.KeyQuantizedMatMulQ5_1, QuantizationKeys.KeyQuantizedMatMulQ5_1, GPUSharpMindConfig.ValQuantizedMatMulQ5_1_Serial)]
    ...
    [PuzzlePeice(QuantizationKeys.KeyQuantizedMatMulQ5_1, QuantizationKeys.KeyQuantizedMatMulQ5_1, GPUSharpMindConfig.ValQuantizedMatMulQ5_1_Parallel)]
        ...
        int M, int K, int N)
    {
        if (M <= 1)
        {
            DecodeParallelGPU(VecDotQ5_1_GPU, input, rawWeights, output, K, N);
        }
        else
        {
            Parallel.For(0, M, row =>
    ...
    [PuzzlePeice(QuantizationKeys.KeyQuantizedMatMulQ5K, QuantizationKeys.KeyQuantizedMatMulQ5K, GPUSharpMindConfig.ValQuantizedMatMulQ5K_Serial)]
    ...
    [PuzzlePeice(QuantizationKeys.KeyQuantizedMatMulQ5K, QuantizationKeys.KeyQuantizedMatMulQ5K, GPUSharpMindConfig.ValQuantizedMatMulQ5K_Parallel)]
        ...
        int M, int K, int N)
    {
        if (M <= 1)
        {
            DecodeParallelGPU(VecDotQ5K_GPU, input, rawWeights, output, K, N);
        }
        else
        {
            Parallel.For(0, M, row =>

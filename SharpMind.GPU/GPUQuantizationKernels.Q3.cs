...
{
    [PuzzlePeice(QuantizationKeys.KeyVecDotQ3K, QuantizationKeys.KeyVecDotQ3K, GPUSharpMindConfig.ValVecDotQ3K)]
    ...
    [PuzzlePeice(QuantizationKeys.KeyQuantizedMatMulQ3K, QuantizationKeys.KeyQuantizedMatMulQ3K, GPUSharpMindConfig.ValQuantizedMatMulQ3K_Serial)]
    ...
    [PuzzlePeice(QuantizationKeys.KeyQuantizedMatMulQ3K, QuantizationKeys.KeyQuantizedMatMulQ3K, GPUSharpMindConfig.ValQuantizedMatMulQ3K_Parallel)]
        ...
        int M, int K, int N)
    {
        if (M <= 1)
        {
            DecodeParallelGPU(VecDotQ3K_GPU, input, rawWeights, output, K, N);
        }
        else
        {

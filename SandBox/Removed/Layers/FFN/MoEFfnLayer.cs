...
public sealed class MoEFfnLayer(ModelConfig config, ActivationOps acts, TensorOps ops, QuantizationOps qOps, LinearLayerFactory layerFactory, TransformerWeights.BlockWeights? weights = null) : FfnLayer(config, acts, ops, FfnKind.MoE, qOps, layerFactory, weights)
{

...
namespace SharpMind.Inference.Chat
{
    public static class ChatSessionFactory
    {
        ...
        public static IChatSession CreateChatSession(
            ...
            Transformer model, Tokenizer tokenizer, ModelMetaData? meta = null, IAgentBuilder? agentBuilder = null, IPromptPreProcessor? preProcessor = null, IContextCompactor? compactor = null, Func<ToolPermissionContext, Task<ToolPermission>>? permissions = null, int? seed = null)
        {
            ...
            return (IChatSession)Activator.CreateInstance(sessionType, [model, tokenizer, meta, agentBuilder, preProcessor, compactor, permissions, null, seed])!;
        }
        ...
        public static ChatSession<T, K> CreateChatSession<T, K>(
            ...
            => new(model, tokenizer, meta, agentBuilder, preProcessor, compactor, permissions, null, seed);
    }
}

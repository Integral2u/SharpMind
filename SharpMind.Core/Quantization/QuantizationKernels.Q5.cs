...
public static partial class QuantizationKernels
{
    ...
    public static unsafe float VecDotQ5K_Scalar(float* input, byte* rawWeights, int col, int inFeatures)
    {
        ...
        for (int b = 0; b < nBlocks; b++)
        {
            ...
            for (int i = 0; i < blockEnd; i++)
            {
                ...
                q5 |= hAdd;
                sum += input[b * QK_K + i] * (sc * q5 * d - mn * min);
            }
        }
        return (float)sum;
    }
        ...
        int M, int K, int N)
    {
        ...
        {
            for (int col = 0; col < N; col++)
                output[col] = VecDotQ5_1_Scalar(input, rawWeights, col, K);
        }
        else
        {
            System.Threading.Tasks.Parallel.For(0, M, row =>
        ...
        int M, int K, int N)
    {
        ...
        {
            for (int col = 0; col < N; col++)
                output[col] = VecDotQ5K_Scalar(input, rawWeights, col, K);
        }
        else
        {
            System.Threading.Tasks.Parallel.For(0, M, row =>
        ...
        int M, int K, int N)
    {
        ...
        {
            for (int col = 0; col < N; col++)
                output[col] = VecDotQ5_1_AVX2(input, rawWeights, col, K);
        }
        else
        {
            System.Threading.Tasks.Parallel.For(0, M, row =>
        ...
        int M, int K, int N)
    {
        ...
        {
            for (int col = 0; col < N; col++)
                output[col] = VecDotQ5_1_FMA(input, rawWeights, col, K);
        }
        else
        {
            System.Threading.Tasks.Parallel.For(0, M, row =>
        ...
        int M, int K, int N)
    {
        ...
        {
            for (int col = 0; col < N; col++)
                output[col] = VecDotQ5K_AVX2(input, rawWeights, col, K);
        }
        else
        {
            System.Threading.Tasks.Parallel.For(0, M, row =>
        ...
        int M, int K, int N)
    {
        ...
        {
            for (int col = 0; col < N; col++)
                output[col] = VecDotQ5K_FMA(input, rawWeights, col, K);
        }
        else
        {
            System.Threading.Tasks.Parallel.For(0, M, row =>
